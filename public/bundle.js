...
function render(variables = {}) {
  ...
  if (variables.name == null) variables.name = "Super";
  if (variables.lastname == null) variables.lastname = "Lunes";
  if (variables.role == null) variables.role = "Selecciona Rol";
  if (variables.city == null) variables.city = "Selecciona Ciudad";
  if (variables.country == null) variables.country = "Selecciona Pais";
  if (variables.socialMediaPosition == null) variables.socialMediaPosition = "class=position-right";
